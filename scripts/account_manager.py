...
管理多个知乎账号，每个账号使用独立的 Chrome Profile：
- 每个账号拥有独立的 user-data-dir，Cookie 隔离
- 账号信息存储在 JSON 配置文件中
- 支持 add/remove/list/switch 操作
...
def main():
    ...
    parser = argparse.ArgumentParser(description="知乎账号管理器")
